...
# 3.  In this example, the resulting frequency is 3.
#
...
# of -2; resulting frequency  2, which has already been seen.  In this example,
# the first frequency reached twice is 2. Note that your device might need to
# repeat its list of frequency changes many times before a duplicate frequency is
# found, and that duplicates might be found while in the middle of processing the
# list.
#
# Here are other examples:
#
# +1, -1 first reaches 0 twice.  +3, +3, +4, -2, -4 first reaches 10 twice.  -6,
# +3, +8, +5, -6 first reaches 5 twice.  +7, +7, -2, -7, -4 first reaches 14
# twice.  What is the first frequency your device reaches twice?
