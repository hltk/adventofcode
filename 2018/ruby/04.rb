...
# time, it's across from the prototype suit manufacturing lab. You need to sneak
# inside and fix the issues with the suit, but there's a guard stationed outside
# the lab, so this is as close as you can safely get.
#
...
# [1518-11-01 00:25] wakes up [1518-11-01 00:30] falls asleep [1518-11-01 00:55]
# wakes up [1518-11-01 23:58] Guard #99 begins shift [1518-11-02 00:40] falls
# asleep [1518-11-02 00:50] wakes up [1518-11-03 00:05] Guard #10 begins shift
# [1518-11-03 00:24] falls asleep [1518-11-03 00:29] wakes up [1518-11-04 00:02]
# Guard #99 begins shift [1518-11-04 00:36] falls asleep [1518-11-04 00:46] wakes
# up [1518-11-05 00:03] Guard #99 begins shift [1518-11-05 00:45] falls asleep
# [1518-11-05 00:55] wakes up Timestamps are written using year-month-day
# hour:minute format. The guard falling asleep or waking up is always the one
# whose shift most recently started. Because all asleep/awake times are during
# the midnight hour (00:00 - 00:59), only the minute portion (00 - 59) is
# relevant for those events.
#
# Visually, these records show that the guards are asleep at these times:
#
# Date   ID   Minute 000000000011111111112222222222333333333344444444445555555555
# 012345678901234567890123456789012345678901234567890123456789 11-01  #10
# .....####################.....#########################.....  11-02  #99
# ........................................##########..........  11-03  #10
# ........................#####...............................  11-04  #99
# ....................................##########..............  11-05  #99
# .............................................##########.....  The columns are
# Date, which shows the month-day portion of the relevant day; ID, which shows
# the guard on duty that day; and Minute, which shows the minutes during which
# the guard was asleep within the midnight hour. (The Minute column's header
